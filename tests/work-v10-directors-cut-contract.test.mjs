...
test("V10 exposes premium interactive stages without fake business claims", () => {
  for (const token of ["director-gallery", "director-capability-stage", "director-process-stage", "director-sound-toggle", "director-reel-controls"]) {
...
test("V10 keeps accessibility and mobile degradation paths", () => {
