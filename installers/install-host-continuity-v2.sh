...
EXPECTED_COMPUTE_SHA='968b634cd87c3dc27b8686dbf695ed3954ce21dc'
COMPUTE_REPO="$HOME/daube/daube-compute-mesh"

log(){ printf '[D’AUBE HOST CONTINUITY V2] %s\n' "$*"; }
fail(){ printf '[D’AUBE HOST CONTINUITY V2] ERROR: %s\n' "$*" >&2; exit 1; }
...
log "HOST_CONTINUITY_V2_VERIFIED computeSha=$EXPECTED_COMPUTE_SHA costCeiling=0 authorityExpanded=false"
